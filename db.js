const db = {
    testimonials: [
        ...
        { id: 3, author: 'Chris Flix', text: 'Eat, pray, love' },
        { id: 4, author: 'Joey Handle', text: 'Fantastic plastic' },
        { id: 5, author: 'Fisher Price', text: 'What are you doin?!' },
        { id: 6, author: 'Alex Dimitrov', text: 'BETHOVEN .' },
        { id: 7, author: 'Alana Jardney', text: 'Big cisty life' },
    ],
    concerts: [
